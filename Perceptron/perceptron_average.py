...
class AveragePerceptronModel(object):
...
model = AveragePerceptronModel(dimensions, learning_rate, 10)
...
av_w = np.zeros(dimensions)
# Train the model
for epoch in range(10):
    av_w = model.train(training_dataset)
